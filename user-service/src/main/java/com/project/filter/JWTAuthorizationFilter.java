...
//        	String user = Jwts.parser().setSigningKey(AuthenticationConfigConstants.SECRET.getBytes("UTF-8"))
//        						.parseClaimsJws(token).getBody().getSubject();
//            
        	DecodedJWT verify = JWT.require(Algorithm.HMAC512(AuthenticationConfigConstants.SECRET.getBytes("UTF-8")))
                .build()
